...
class CestaController {
    ...
    async addProduct(req, res) {
        ...
        try {
            ...
            res.status(500).json({ error: 'Ocorreu um erro ao adicionar o produto à cesta.' }); 
        }
    }
    ...
    async viewCesta(req, res) {
        ...
        try {
            ...
            res.status(500).json({ error: 'Ocorreu um erro ao visualizar a cesta.' }); 
        }
    }
    ...
    async removeProduct(req, res) {
        ...
        try {
            ...
            res.status(500).json({ error: 'Ocorreu um erro ao remover o produto da cesta.' }); 
        }
    }
    ...
    async clearCesta(req, res) {
        ...
        try {
            ...
            res.status(500).json({ error: 'Ocorreu um erro ao limpar a cesta.' }); 
        }
    }
    ...
    async updateProductQuantity(req, res) {
        ...
        try {
            ...
            res.status(500).json({ error: 'Ocorreu um erro ao atualizar a quantidade do produto.' }); 
        }
    }
}
